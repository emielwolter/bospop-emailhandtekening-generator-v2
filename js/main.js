...
const ICON_PHONE = `<img src="${ASSET_BASE_URL}/icon-phone.png" alt="Tel" width="12" height="12" border="0" style="${ICON_STYLE}" />`;
const ICON_MAIL = `<img src="${ASSET_BASE_URL}/icon-mail.png" alt="E-mail" width="12" height="12" border="0" style="${ICON_STYLE}" />`;
const ICON_WEB = `<img src="${ASSET_BASE_URL}/icon-web.png" alt="Website" width="12" height="12" border="0" style="${ICON_STYLE}" />`;
const ICON_LINKEDIN = `<img src="${ASSET_BASE_URL}/icon-linkedin.png" alt="LinkedIn" width="12" height="12" border="0" style="${ICON_STYLE}" />`;
...
const NAME_LINE_STYLE =
  "font-size:23pt; font-family:Arial, Helvetica, sans-serif; color:#000000; line-height:30px; mso-line-height-rule:exactly; text-transform:uppercase; font-weight:600; padding-top:1px; padding-bottom:1px; padding-left:0; padding-right:0;";
...
function renderSignature(data) {
  ...
  const noteRow = note
    ...
    <tr>
      <td colspan="3"
        style="padding-top:10px; padding-right:20px; padding-bottom:10px; padding-left:20px; line-height:11px; mso-line-height-rule:exactly; word-break:break-word;">
        <span
          style="font-size:9pt; font-family:Arial, Helvetica, sans-serif, 'test'; color:#000000; line-height:11px; mso-line-height-rule:exactly;">${note}</span>
      </td>
    </tr>`
    : "";
...
<table role="presentation" cellpadding="0" cellspacing="0" border="0" width="600" align="left"
  style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt; table-layout:fixed; color:#262626; font-family:Arial, Helvetica, sans-serif, 'test'; width:600px;">
  <tbody>
    <tr>
      <td width="300" valign="top" style="padding:0; vertical-align:top;">
